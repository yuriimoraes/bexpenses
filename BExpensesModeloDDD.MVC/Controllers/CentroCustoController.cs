...
namespace BExpensesModeloDDD.MVC.Controllers
{
    ...
    {
        private readonly RepositoryCentroCusto _centroCustoRepository = new RepositoryCentroCusto();
        //
        // GET: /CentroCusto/
        public ActionResult Index()
        {
            var centroCustoViewModel = Mapper.Map<IEnumerable<CentroCusto>, IEnumerable<CentroCustoViewModel>>(_centroCustoRepository.GetAll());
        ...
        public ActionResult Create(CentroCustoViewModel centrocusto)
        {
            if (ModelState.IsValid) 
            {
                ...
                _centroCustoRepository.Add(centrocustoDomain);
